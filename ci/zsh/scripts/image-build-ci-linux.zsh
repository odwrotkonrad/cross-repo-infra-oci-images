...
typeset che_ref=$(curl --connect-timeout 30 --retry 5 --retry-delay 2 -fsSI "https://gitlab.com/api/v4/projects/konradodwrot%2Fgo-modules/packages/generic/che/latest/che_latest_linux_amd64.tar.gz" | tr -d '\r' | awk 'tolower($1)=="etag:"{print $2}')
