<!-- autogenerated using @gitlab.com/konradodwrot/prose//repos/infra/oci-images/templates/3-audience/README.md.ontoRepo.tpl?ref=v0.0.32 -->
# oci-images
...
chains to the `infra/sandbox` image, which owns its own bake.
